...
export default function ApiFlows() {
  return (
    <DocPage slug="api/flows" lede="Catalog operations for flows. The list view merges built-in flows (compiled into the binary) with custom flows (stored in the DB). Built-in flows are read-only via the API; custom flows are full CRUD.">
